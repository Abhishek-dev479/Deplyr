          ...
          <div className="space-y-4">
            ...
            <Button onClick={async () => {
              ...
              const interval = setInterval(async () => {
                ...
                const mesResponse = await axios.get(`${BACKEND_UPLOAD_URL}/message?id=${res.data.id}`);
                console.log(mesResponse);
                if(response.data.status == 'error') setMessage(mesResponse.data.status)
      ...
      {deployed && <Card className="w-full max-w-md mt-8">
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Input id="deployed-url" readOnly type="url" value={`http://${uploadId}.deplyr.com:3001/index.html`} />
          </div>
          <br />
          <Button className="w-full" variant="outline">
            <a href={`http://${uploadId}.deplyr.com/index.html`} target="_blank">
              Visit Website
            </a>
          </Button>
        </CardContent>
